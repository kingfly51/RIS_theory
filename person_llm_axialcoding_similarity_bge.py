...
# 路径配置
outpath = 'E:/Rdaima/RIS_theory/person_llm_axialcoding_similarity_bge'
...
if __name__ == '__main__':
    ...
    pairing_file = os.path.join(outpath, '编码名称配对相似度结果_bge-m3.csv')
    ...
    matrix_file = os.path.join(outpath, '相似度矩阵_bge-m3.csv')
    ...
    stats_file = os.path.join(outpath, '总体相似度统计_bge-m3.csv')
